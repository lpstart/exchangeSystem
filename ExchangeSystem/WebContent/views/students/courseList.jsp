	...
	<div class="pagination">
		<ul>
			...
			<c:if test="${stuCoursesPage.pageIndex > 1}">
				<li><a href="CourseList.htm?pageIndex=${stuCoursesPage.pageIndex - 1}">Prev</a></li>
			</c:if>
			<c:forEach var="i" begin="1" end="${stuCoursesPage.totalPage}">
				<li><a href="CourseList.htm?pageIndex=${i}">${i}</a></li>
			</c:forEach>
			<c:if test="${stuCoursesPage.pageIndex < stuCoursesPage.totalPage}">
				<li><a href="CourseList.htm?pageIndex=${stuCoursesPage.pageIndex + 1}">Next</a></li>
			</c:if>
		</ul>
	</div>
</div>
