...
public class CourseList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		List<Map<String, Object>> CoursesList = GetCourse.getNoExchange(
		...
		stuCoursesPage.setTotleSize(GetCourse
				.getTotalNumberCoursesNoExchange(studentID));

		req.setAttribute("stuCoursesPage", stuCoursesPage);
		req.getRequestDispatcher("/views/students/courseList.jsp").forward(req,
				resp);
	}
