...
public class CoursesSelectionForm extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2634511291556287354L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		List<Map<String, Object>> CoursesList = GetCourse
				.getSelectingNoExchange(studentID, (pageIndex - 1) * pageSize,
						pageSize);
		// 设置返回给用户的课程列表
		...
		stuCoursesPage.setTotleSize(GetCourse
				.getTotalNumberSelectingCoursesNoExchange(studentID));

		req.setAttribute("stuCoursesPage", stuCoursesPage);
		req.getRequestDispatcher("/views/students/courseSelectionForm.jsp")
				.forward(req, resp);
	}
