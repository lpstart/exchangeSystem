...
public class CoursesSelectionFormOutcome extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2855140562382813282L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		List<Map<String, Object>> CoursesList = GetCourse
				.getSelectingExchange(studentID, (pageIndex - 1) * pageSize,
						pageSize);
		// 设置返回给用户的课程列表
		...
		stuCoursesPage.setTotleSize(GetCourse
				.getTotalNumberSelectingCoursesExchange(studentID));

		req.setAttribute("stuCoursesPage", stuCoursesPage);
		req.getRequestDispatcher("/views/students/courseSelectionFormOutcome.jsp")
				.forward(req, resp);
	}
}
